...
public class EntryPoint {
    private static readonly double FadeInMS = 500.0;
    private static readonly CurveType FadeInCurve = CurveType.Smooth;
    private static readonly double FadeOutMS = 1000.0;
